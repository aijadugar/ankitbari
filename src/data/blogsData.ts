...
export const blogsData: Blog[] = [
  {
    ...
    description:
      "A short note on why I started SkyBoy and what I learned while shipping an agent-agnostic directory of AI skills.",
    content: [
      {
        type: "paragraph",
        text: "This is a placeholder blog post. Replace this with real content soon.",
      },
      {
        type: "quote",
