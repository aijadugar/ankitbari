...
export const ProjectCard = ({
  ...
  const statusColor = isBuilding ? "bg-red-500" : "bg-emerald-500";
    ...
    <>
      <div className="flex flex-col relative z-10 w-full">
        ...
        <div className="relative w-full h-0 hidden md:block">
          ...
          {/* Intersections */}
          <div className="absolute top-0 -left-4 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-20" />
          <div className="absolute top-0 -right-4 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] translate-x-1/2 -translate-y-1/2 pointer-events-none z-20" />
          <div className="absolute top-0 left-1/2 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-20" />
        </div>
