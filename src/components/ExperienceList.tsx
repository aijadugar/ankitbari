      ...
      {visibleExperiences.map((item, idx) => {
        ...
        return (
          <div key={idx} className="group relative">
            ...
            <div
              className={`flex items-start justify-between gap-4 py-3.5 px-4 -mx-4 hover:bg-zinc-50 dark:hover:bg-zinc-900/20 transition-colors cursor-pointer relative z-20 rounded-lg sm:py-4 ${idx === visibleExperiences.length - 1 ? "rounded-b-lg" : ""}`}
