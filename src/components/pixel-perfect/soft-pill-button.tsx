    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          isPrimary ? "text-neutral-50 dark:text-white" : "text-neutral-900 dark:text-neutral-300",
          className,
        )}
        {...props}
      >
        <span
          ...
          className={cn(
            ...
            isPrimary
              ? "bg-[#18181b] group-hover:bg-[#27272a] dark:bg-[#4f46e5] dark:group-hover:bg-[#6366f1] border border-black/10 dark:border-[#7a73f0]/40"
              : "bg-white/90 dark:bg-[#161b22] group-hover:dark:bg-[#1c232e] border border-black/5 dark:border-white/5 group-hover:border-black/10 dark:group-hover:border-[#4f46e5]/40"
          )}
        >
          {!isPrimary && (
            <span
