...
const darkBannerImage = "/placeholder.png";
...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    name: "Ankit Bari",
    handle: "aijadugar",
    avatar: "https://github.com/aijadugar.png",
    bio: "AI and Research Engineer • building CUDA kernels",
    location: "India",
    stats: [
  ...
  "Hugging Face": {
    ...
    bio: "AI and Research Engineer • Multimodal & Multilingual models",
    location: "India",
    stats: [],
  },
  Kaggle: {
    name: "Ankit Bari",
    handle: "bariankitvinod",
    avatar: "/placeholder.png",
    banner: darkBannerImage,
    bio: "AI and Research Engineer • building models with limited resources",
    location: "India",
    stats: [],
  },
  LinkedIn: {
  ...
  Substack: {
    ...
    avatar: "/placeholder.png",
    banner: darkBannerImage,
    bio: "Writing about AI research, CUDA kernels, and model architectures.",
    location: "India",
    stats: [],
  },
  Discord: {
