      ...
      <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
        ...
        >
          <div className="relative pt-6 pb-6">
            ...
            <div className="absolute top-0 left-1/2 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-20 hidden md:block" />
                  ...
                  <div key={rowIndex} className="flex flex-col relative w-full">
                    ...
                    {rowIndex < Math.ceil(projectsData.length / 2) - 1 && (
                      <div className="relative w-full h-0 hidden md:block">
                        ...
                        <div className="absolute -left-4 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
                        <div className="absolute -right-4 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
                        <div className="absolute left-1/2 w-[2px] h-[2px] bg-black/40 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
                      </div>
                    )}
                  </div>
                );
