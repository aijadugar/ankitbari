    ...
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-16 px-4 flex flex-col z-10 relative">
        ...
        <div className="relative mt-8">
          ...
          <div className="absolute left-0 w-[2px] h-[2px] bg-black/50 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 translate-y-[-1px] pointer-events-none z-20" />
          <div className="absolute right-0 w-[2px] h-[2px] bg-black/50 dark:bg-[#4f46e5]/[0.35] translate-x-1/2 translate-y-[-1px] pointer-events-none z-20" />
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 items-center justify-between py-4 relative">
          ...
          {/* Vertical Divider 1 */}
          <div className="hidden md:block absolute left-1/3 top-0 bottom-0 w-0 border-l border-black/30 dark:border-[#2a303c] pointer-events-none" style={{ maskImage: 'repeating-linear-gradient(to bottom, black 0, black 1px, transparent 1px, transparent 6px)', WebkitMaskImage: 'repeating-linear-gradient(to bottom, black 0, black 1px, transparent 1px, transparent 6px)' }} />
          ...
          {/* Vertical Divider 2 */}
          <div className="hidden md:block absolute left-2/3 top-0 bottom-0 w-0 border-l border-black/30 dark:border-[#2a303c] pointer-events-none" style={{ maskImage: 'repeating-linear-gradient(to bottom, black 0, black 1px, transparent 1px, transparent 6px)', WebkitMaskImage: 'repeating-linear-gradient(to bottom, black 0, black 1px, transparent 1px, transparent 6px)' }} />
          ...
          <div className="flex items-center gap-2">
            {project.status === "building" ? (
              <>
                ...
                <span className="text-[13px] font-medium text-red-600 dark:text-red-400">Building</span>
              </>
            ) : (
              <>
                <span className="relative flex h-2 w-2">
