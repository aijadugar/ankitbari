    ...
    <CurrentTime />
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-0 px-8 md:px-4 flex flex-col z-10 relative">
        ...
        <div className="relative mt-16 mb-0">
          ...
          {/* Intersection nodes */}
          <div className="absolute -left-8 md:-left-4 w-[2px] h-[2px] bg-black/50 dark:bg-[#4f46e5]/[0.35] -translate-x-1/2 translate-y-[-1px] pointer-events-none z-20" />
          <div className="absolute -right-8 md:-right-4 w-[2px] h-[2px] bg-black/50 dark:bg-[#4f46e5]/[0.35] translate-x-1/2 translate-y-[-1px] pointer-events-none z-20" />
        </div>
