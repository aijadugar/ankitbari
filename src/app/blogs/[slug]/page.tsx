...
function BlueprintFrame() {
  return (
    <>
      <div
        className="absolute top-0 bottom-0 left-[30%] hidden w-0 border-r border-black/30 pointer-events-none dark:border-[#2a303c] md:block"
        style={verticalDashes}
      />
      <div
        className="absolute top-0 bottom-0 right-[30%] hidden w-0 border-r border-black/30 pointer-events-none dark:border-[#2a303c] md:block"
        style={verticalDashes}
      />

      <div
        className="absolute left-0 right-0 top-[22vh] h-0 border-b border-black/30 pointer-events-none dark:border-[#2a303c]"
        style={horizontalDashes}
      />
      <div
        className="absolute left-0 right-0 top-[calc(22vh+112px)] h-0 border-b border-black/30 pointer-events-none dark:border-[#2a303c]"
        style={horizontalDashes}
      />
      ...
      {[
        ...
        <div
          key={index}
          className="absolute hidden h-[2px] w-[2px] bg-black/50 pointer-events-none dark:bg-[#4f46e5]/[0.35] md:block"
          style={{
            top: position.top,
            left: position.left,
...
function BlueprintDivider({ className = "" }: { className?: string }) {
  return (
    <div className={`relative ${className}`}>
      <div
        className="absolute left-[-100vw] right-[-100vw] h-0 border-b border-black/30 pointer-events-none dark:border-[#2a303c]"
        style={horizontalDashes}
      />
      <div className="absolute left-0 h-[2px] w-[2px] -translate-x-1/2 translate-y-[-1px] bg-black/50 pointer-events-none dark:bg-[#4f46e5]/[0.35]" />
      <div className="absolute right-0 h-[2px] w-[2px] translate-x-1/2 translate-y-[-1px] bg-black/50 pointer-events-none dark:bg-[#4f46e5]/[0.35]" />
    </div>
  );
}
          ...
          {block.items.map((item) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-[13px] font-bold text-zinc-900 transition-colors group-hover:text-blue-600 dark:text-zinc-100 dark:group-hover:text-[#818cf8]">
                    {item.title}
                  </h3>
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-white transition-colors duration-300 dark:bg-black">
      ...
      <main className="relative z-10 ml-0 mr-0 flex flex-col px-4 pb-16 pt-[calc(22vh+112px)] md:ml-[30%] md:mr-[30%]">
        ...
        <div className="relative mt-12 h-[220px] w-[calc(100%+32px)] -mx-4 overflow-hidden">
          <div
            className="absolute left-[-100vw] right-[-100vw] top-0 z-10 h-0 border-t border-black/30 pointer-events-none dark:border-[#2a303c]"
            style={horizontalDashes}
          />
          <div className="absolute left-0 top-0 z-20 h-[2px] w-[2px] -translate-x-1/2 -translate-y-1/2 bg-black/50 pointer-events-none dark:bg-[#4f46e5]/[0.35]" />
          <div className="absolute right-0 top-0 z-20 h-[2px] w-[2px] translate-x-1/2 -translate-y-1/2 bg-black/50 pointer-events-none dark:bg-[#4f46e5]/[0.35]" />
          <FooterBackground />
        </div>
      </main>
    </div>
